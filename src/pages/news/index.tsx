    ...
    <Link key={id} href={`/notams/${id}`}>
        ...
        >
            {metaImage
                ...
                : <></>}
            <div className="p-6">
                <div className="flex flex-wrap gap-x-4 justify-end font-sans md:text-lg">
                    {category === 'Announcements'
                        ...
                        : (
                            <p
                                className="self-center py-1 px-4 text-lg font-semibold text-amber-500 bg-amber-100 rounded-md"
                            >
                                {category}
                            </p>
                        )}
    ...
    <Link key={id} href={`/news/${id}`}>
        ...
        >
            ...
            <div className="px-5 pt-5 pb-8 h-[167.38px] md:px-10">
                <div className="flex flex-wrap gap-x-4 justify-between font-sans text-md">
                    ...
                    {category === 'Announcements'
                        ? (
                            <p
                                className="self-center py-1 px-4 text-xs font-semibold text-blue-sky bg-blue-100 bg-opacity-10 rounded-md"
                            >
                                {category}
                            </p>
                        )
                        : (
                            <p
                                className="self-center py-1 px-4 text-xs font-semibold text-amber-500 bg-amber-100 bg-opacity-10 rounded-md"
                            >
                                {category}
                            </p>
                        )}
