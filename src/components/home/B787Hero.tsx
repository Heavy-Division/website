...
export const B787Hero = () => {
    return (
            <section id="hero">
                <Image src={"/img/image4.jpg"} objectFit={"cover"} layout={"fill"} className="opacity-60" />
                <Container className="grid place-items-center md:justify-end max-w-6xl md:max-w-7xl mx-auto h-screen">
                    ...
                    <div className="grid grid-col md:grid-cols-2 text-2xl justify-center gap-x-8 z-10">
