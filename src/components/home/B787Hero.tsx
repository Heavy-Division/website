...
export const B787Hero = () => {
    ...
    return (
            <section id="B787Hero">
                ...
                <div className="grid grid-col justify-center py-12 gap-y-12">
                ...
                <Button className="border-2 border-blue-sky w-48 md:w-72 h-18 md:h-16 text-2xl md:text-3xl mt-5 hover:bg-blue-sky">
